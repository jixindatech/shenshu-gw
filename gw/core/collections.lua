...
_M.lookup = {
    access = function(config, collections, ctx)
        ...
        local request_body_args   = request.parse_request_body(config, request_headers, collections)
        ...
        collections.BODY_ARGS         = request_body_args
        collections.REQUEST_BODY      = nil
        collections.REQUEST_ARGS      = request_uri_args
